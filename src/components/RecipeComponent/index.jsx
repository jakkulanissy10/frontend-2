...
//GET method 
  ...
  fetchRecipes = async () => {
    try {
      const response = await axios.get("https://backend-recipe-2.onrender.com/recipes");
  ...
  updateRecipe = async () => {
    try {
      await axios.put(`https://backend-recipe-2.onrender.com/recipes/${this.state.selectedRecipe._id}, this.state.selectedRecipe`);
  ...
  addRecipe = async () => {
    try {
      await axios.post("https://backend-recipe-2.onrender.com/recipes", this.state.newRecipe);
